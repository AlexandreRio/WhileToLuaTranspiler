 ...
 * <ul>
 *   <li>{@link org.xtext.tl.mydsl.myDsl.impl.LexprImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LexprImpl extends MinimalEObjectImpl.Container implements Lexpr
{
  ...
  public EList<Expr> getExp()
  {
    if (exp == null)
    {
      exp = new EObjectContainmentEList<Expr>(Expr.class, this, MyDslPackage.LEXPR__EXP);
    }
    return exp;
  }
